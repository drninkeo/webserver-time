(() => {
    ...
    ////////////////////////////////////////////////////////////
    ///                                                      ///
    ///  TIME DISPLAY SCRIPT FOR FM-DX-WEBSERVER (V2.1)      ///
    ///                                                      ///
    ...
    function initializeTimeDisplay() {
        ...
        // Set container position based on viewport
        ...
        // Set display based on displayState
        const setDisplay = () => {
            if (displayState === 0) {
        ...
        // Toggle display state on click and save to localStorage
        container.addEventListener('click', () => {
            displayState = (displayState + 1) % 3;
            localStorage.setItem('displayState', displayState);
            setDisplay(); // Update display after toggling
        });
        ...
        if (window.innerWidth > 930) {
            ...
            tunerInfoStyle.innerHTML = `.tuner-info { text-align: left; }`;
